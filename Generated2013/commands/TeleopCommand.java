 ...
 *
 */
public class  TeleopCommand extends Command {// RobotBuilder Version: 0.0.2

    private Command useflap;
    ...
    protected void initialize() {
        useflap = new UseFlap(Robot.oi.getJoystick1());
    ...
    protected void execute() {
        ...
        RobotMap.doubler = OI.creeper.get()?0.4:1.0;
        useflap.start();
    }
