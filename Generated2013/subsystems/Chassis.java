...
public class Chassis extends Subsystem {
    ...
    double doubler = RobotMap.doubler;
...
//    DoubleSolenoid chassisPneumatics1 = RobotMap.chassisPneumatics1;
    ...
    public void driveWithJoystick(Joystick stick) {
        ...
        if (RobotMap.Teleop){
            robotDrive41.mecanumDrive_Cartesian(deadZone(-stick.getX()*doubler),deadZone(-stick.getY()*doubler),deadZone2(-stick.getTwist()*doubler*0.75),0.0);
        }
//        if (OI.safety.get()) {
...
//        }
    ...
    public void manualControl(double a, double b, double c){
        robotDrive41.mecanumDrive_Cartesian(a,b,c,0.0);
    }
    
    public void forward() {
        robotDrive41.mecanumDrive_Cartesian(0.0, -0.75, 0.0, 0.0);
    ...
    private double deadZone2(double position){
        if (Math.abs(position)<= 0.15) { return 0.0; }
        return position;
    }
